                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-5 col-xs-12">
                            ...
                            <table class="style1">
            <tr>
                <td class="auto-style4" style="color: #fff; font-size: large;">
                Search&nbsp; </td>
                ...
                <td class="auto-style4">
                    ...
                    <asp:Button ID="Button1" class="btn add-new" runat="server" Text="Search" Font-Bold="true" onclick="Button1_Click" Width="76px" />
                        ...
                        <div class="col-sm-7 col-xs-10 text-right">
                            <div class="btn_group">
                                <button class="btn add-new"><span class="fa fa-print" aria-hidden="true"></span> Print</button>

                            </div>
                            <a href="#" class="btn add-new"><i class="fa fa-plus-circle"></i>
                                Add New
                            </a>
                        </div>
                    </div>

                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body table-responsive">
                                <table class="table table-hover">
                                    <tbody>
                                        <asp:GridView ID="GridViewRecReq" ShowHeaderWhenEmpty="True" BorderColor="Aqua" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false" align="center" AllowPaging="true" OnPreRender="GridViewRecReq_PreRender" PageSize="15" OnPageIndexChanging="OnPageIndexChanging" Style="text-align: center">
                                            <Columns>
